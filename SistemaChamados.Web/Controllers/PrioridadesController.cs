...
namespace SistemaChamados.Web.Controllers
{
    public class PrioridadesController : Controller
    {
        ...
        public PrioridadesController(IHttpClientFactory httpClientFactory, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> GetPrioridades()
        {
            try
            {
                ...
                var response = await _httpClient.GetAsync($"{_apiBaseUrl}/api/Prioridades");
