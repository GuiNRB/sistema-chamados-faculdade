...
public static class Constants
{
    ...
    public static string BaseUrlWindows => "http://localhost:5123/api/";
    
    // Para Emulador Android (10.0.2.2 = localhost do host)
    public static string BaseUrlAndroidEmulator => "http://10.0.2.2:5123/api/";
    ...
    public static string BaseUrlPhysicalDevice => "http://192.168.56.1:5123/api/";
